...
const editPackage = lazy(() => import("./views/packageManagement/editPackage"))
const managePackage = lazy(() => import("./views/packageManagement/managePackage"))
const createPackage = lazy(() => import("./views/packageManagement/createPackage"))
...
const packageManagement = lazy(() => import("./views/packageManagement/index"))
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute path="/app/user/addUser" component={userForm} />
          <AppRoute path="/app/user/editUser" component={editUser} />
          <AppRoute path="/package-mgmnt" component={packageManagement} />
          <AppRoute path="/app/user/createPackage" component={createPackage} />
          <AppRoute path="/app/user/editPackage" component={editPackage} />
          <AppRoute path="/app/user/managePackage" component={managePackage} />
