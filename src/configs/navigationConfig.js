...
const navigationConfig = [
  ...
  },
  {
    ...
    icon: <Icon.CheckSquare size={20} />,
    permissions: ["admin", "editor"],
    navLink: "/analytics-dashboard2",
  },
  {
    id: "analyticsDash",
    title: "Device Nursing Home Management",
    type: "item",
    icon: <Icon.CheckSquare size={20} />,
    permissions: ["admin"],
    navLink: "/ecommerce-dashboard3"
  },
  {
    id: "analyticsDash",
